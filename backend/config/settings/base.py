...
# Directory for log files (auto-created so RotatingFileHandler can initialise)
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-fallback-secret-key-orbitpm-2026')
...
MIDDLEWARE = [
    ...
    'common.middleware.RequestCorrelationMiddleware',  # Assign correlation ID early
    'django.middleware.security.SecurityMiddleware',
    'django.contrib.sessions.middleware.SessionMiddleware',
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsFilterMiddleware' if 'CsFilterMiddleware' in globals() else 'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'common.middleware.APIRequestLoggingMiddleware',  # Log API requests (must be late)
]
...
# Simple JWT JWT Authentication Settings
SIMPLE_JWT = {
...
LOGGING = {
    ...
    'loggers': {
        # Common app — middleware, exceptions, services
        'common': {
